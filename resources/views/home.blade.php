...
<div class="page-wrapper">
    ...
    <section class="video-section" style="background-image:url(images/background/7.jpg)">
    	<div class="auto-container">
        	<a href="https://www.youtube.com/watch?v=kxPCFljwJws" class="lightbox-image play-icon wow bounceIn" data-wow-delay="0ms" data-wow-duration="1500ms"><span class="flaticon-play-button-5"></span></a>
    ...
    <section class="price-section">
    	<div class="auto-container">
        	<!--Sec Title-->
        	<div class="sec-title centered">
            	<div class="title">Select Priceing Scheme</div>
            ...
            <div class="row clearfix">
                ...
                <div class="price-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="upper-box" style="background-image:url(images/resource/image-4.jpg)">
                            <div class="title">For a Regular Buget</div>
                            <h2>Basic Plan</h2>
                        </div>
                        <div class="price"><sub>$</sub>79</div>
                        ...
                        <a class="purchased" href="#">Purchased</a>
                    </div>
                </div>
                ...
                <div class="price-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="upper-box" style="background-image:url(images/resource/image-4.jpg)">
                            <div class="title">For a Luxury Buget</div>
                            <h2>Standard Plan</h2>
                        </div>
                        <div class="price"><sub>$</sub>88</div>
                        <div class="middle-box">
                        	<ul>
                            	<li>Large Budget Properties</li>
                                <li>Luxury Interior Design</li>
                                <li>Standard Exterior Design</li>
                                <li>Plan Modeling</li>
                                <li>Onsite Maintanance Support</li>
                                <li>24/7 Customer Help Desk</li>
                            </ul>
                        </div>
                        <a class="purchased" href="#">Purchased</a>
                ...
                <div class="price-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="upper-box" style="background-image:url(images/resource/image-4.jpg)">
                            <div class="title">For a Royal Buget</div>
                            <h2>Premium Plan</h2>
                        </div>
                        <div class="price"><sub>$</sub>99</div>
                        <div class="middle-box">
                        	<ul>
                            	<li>Huge Budget Properties</li>
                                <li>Premium Interior Design</li>
                                <li>Premium Exterior Design</li>
                                <li>3D Plan Rendering</li>
                                <li>Live Maintanance Support</li>
                                <li>24/7 Customer Help Desk</li>
                            </ul>
                        </div>
                        <a class="purchased" href="#">Purchased</a>
